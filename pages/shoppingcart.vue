            ...
            <div v-else class="md:flex gap-4 justify-between mx-auto w-full">
                ...
                <div class="md:w-[35%]">
                    <div id="Summary" class="bg-white rounded-lg p-4">
                        ...
                        <button
                            @click="goToCheckout"
                            class="flex items-center justify-center bg-[#FD374F] w-full text-white text-[21px] font-semibold
                                p-1.5 rounded-full mt-4"
                        >
                            Checkout
                        </button>
                    </div>
...
const selectedRadioFunc = (e) => {
    if (e.val) {
        ...
        selectedArray.value = selectedArray.value.filter((item) => item.id !== e.id)
    }
}
